...
namespace GUI
{
    public partial class Entidades : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                if (this.txtBP.Text.Trim() == "") throw new Exception("El codigo del BussinesPartner debe ser obligatorio");
                if (oSAP.UpdateBussinesPartner(this.txtBP.Text.Trim()))
                {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                csJournalEntry oJE = new csJournalEntry();
                csJournalEntryLines oLine;
                csJournalEntryLines oLine2;
                ...
                oLine2 = new csJournalEntryLines();
                oLine2.Account = "4115102";
                oLine2.Debit = 0;
                oLine2.FCDebit = 0;
                oLine2.FCCredit = 0;
                ...
                string sTransID = "";
                if (oSAP.AddJournalEntries(oJE, ref sTransID))
                {
                    MessageBox.Show("Asiento Agregado");

                    this.txtJE.Text = sTransID;
                }
                else
                {
                    MessageBox.Show("Error al agregar Asiento");
                }
            }
            catch (Exception ex)
            {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            try
            {
                if (this.txtJEC.Text.Trim() == "") throw new Exception("El ID del Asiento debe ser obligatorio");
               string sCancelTransID = "";
                if (oSAP.CancelJournalEntries(Int32.Parse(txtJEC.Text), ref sCancelTransID))
                {
                    this.txtJECC.Text = sCancelTransID;
